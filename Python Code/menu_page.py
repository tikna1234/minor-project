...
class Ui_MenuWindow(object):
    def setupUi(self, MenuWindow):
        ...
        self.ITIReq = {"Computer Science and Information Technology":[60,65,60,60,65],
          "Mechanical and Electrical":[60,65,65,60,60],
          "Electronics and Communication":[60,65,65,56,60],
          "Construction and Design":[60,65,65,60,56],
          "Physical Education and Wellness":[65,60,65,60,56]}
    ...
    def GenReport(self, MenuWindow, recommend, courses, branch, weaksubs):
        ...
        for i in range(len(weaksubs)):
            temp = "\n".join(weaksubs)
        if temp == "":
            self.ui.WeakLbl.setText("No weaknesses against interest")
        else: 
